...
public class PlayerMovement : MonoBehaviour
{
    ...
    // allow a brief moment of using movement ability to allow player to get speed from movement functions that are instantanious
    ...
    {
        // set the player to be using a movement ability for 0.25 seconds
