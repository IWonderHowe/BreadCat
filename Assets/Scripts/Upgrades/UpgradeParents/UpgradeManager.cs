...
public class UpgradeManager : MonoBehaviour
{
    ...
    [SerializeField] BoolEvent _playerWinsEvent;
    ...
    private void FillAvailableUpgradesList()
    {
    ...
    public void StartPlayerUpgradeScreen(bool invoked)
    {
        ...
        _aquisition1.SetUpgrade(button1Upgrade);
        _aquisition2.SetUpgrade(button2Upgrade);
        _aquisition3.SetUpgrade(button3Upgrade);
    ...
    public void AquireUpgrade(GameObject upgradeObject)
    {
        ...
        // if the player has 5 upgrades, show the win screen
        if(_currentUpgrades.Count >= 5)
        {
            _playerWinsEvent.Invoke(true);
            return;
        }
